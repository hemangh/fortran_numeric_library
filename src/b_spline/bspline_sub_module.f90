...
!  * Jacob Williams, 2/24/2015 : Created this routine.
    ...
    contains
        ...
        if (present(n) .and. present(k) .and. present(x) .and. present(t)) then
            ...
            ierr_arr = [ierrs(1),ierrs(5)]
            call check_n('n'//s,n,x,ierr_arr,iflag,error); if (error) return
            ...
            if (iknot /= 0) then
                ...
                ierr_arr = [ierrs(4),ierrs(6)]
                call check_t('t'//s,n,k,t,ierr_arr,iflag,error); if (error) return
            end if
        end if
